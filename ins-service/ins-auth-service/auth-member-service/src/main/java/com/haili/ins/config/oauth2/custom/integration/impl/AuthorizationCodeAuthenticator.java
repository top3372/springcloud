...
@Component
@Primary
public class AuthorizationCodeAuthenticator extends AbstractPreparableIntegrationAuthenticator {

    private final static String AUTH_TYPE = "authorization_code";
