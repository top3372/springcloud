package com.haili.ins.core.cat;
...
public class CatHttpConstants {
	...
	public static final String CAT_HTTP_HEADER_APPLICATION_KEY = "X-CAT-APPLICATION_KEY";



	public static final String PROVIDER_CALL_APP = "Service.app";

	public static final String PROVIDER_CALL_SERVER = "Client";
}