package com.haili.ins.common.utils.poi;

import com.haili.ins.common.annotation.Excel;
import com.haili.ins.common.annotation.Excel.Type;
import com.haili.ins.common.config.GlobalConfiguration;
import com.haili.ins.common.convert.Convert;
import com.haili.ins.common.exception.CommonServiceException;
import com.haili.ins.common.utils.ReflectUtils;
...
public class ExcelUtil<T> {
    ...
    public ResultInfo exportExcel() {
        ...
        try {
            ...
            wb.write(out);
            return ResultInfo.success(filename, "success");
        } catch (Exception e) {
            log.error("导出Excel异常{}", e.getMessage());
            throw new CommonServiceException("导出Excel失败，请联系网站管理员！");
        } finally {
            if (wb != null) {
                try {
                    wb.close();
    ...
    public String getAbsoluteFile(String filename) {
        String downloadPath = GlobalConfiguration.getDownLoadPath() + filename;
